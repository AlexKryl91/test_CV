...
`,W=({caption:e,groups:t},n)=>`
      ...
      `;function H(e){if(e.currentTarget.classList.contains("container_active")){const t=e.currentTarget,n=document.createElement("span"),s=Math.min(t.clientWidth,t.clientHeight),i=s/2;n.style.width=n.style.height=`${s}px`,n.style.left=`${e.clientX-t.offsetLeft-i}px`,n.style.top=`${e.clientY-t.offsetTop-i}px`,n.classList.add("ripple"),t.appendChild(n),setTimeout(()=>t.querySelector(".ripple").remove(),600)}}function g(e){const t=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)?1:2,n={margin:0,filename:"test_CV.pdf",image:{type:"jpeg",quality:1},html2canvas:{scale:t,width:e.clientWidth,height:e.clientHeight,x:(window.innerWidth-e.clientWidth)/2},jsPDF:{unit:"px",hotfixes:["px_scaling"],format:[e.clientWidth,e.clientHeight],orientation:"portrait",putOnlyUsedFonts:!0}};html2pdf().set(n).from(e).save()}JSON.parse(localStorage.getItem("_cvData"));const A=()=>`
