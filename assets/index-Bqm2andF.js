(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();const y="/test_CV/img/figma.svg",$="/test_CV/img/photoshop.svg",w="/test_CV/img/illustrator.svg",_="/test_CV/img/premiere.svg",L="/test_CV/img/notion.svg",k="/test_CV/img/google_meet.svg",C="/test_CV/img/zapier.svg",E="/test_CV/img/webflow.svg",S="/test_CV/img/framer.svg",P="/test_CV/img/wordpress.svg",j="/test_CV/img/chat_gpt.svg",I="/test_CV/img/copilot.svg",x="/test_CV/img/midjourney.svg",V=[{caption:"design",icons:[{path:y,ref:"https://www.figma.com/"},{path:$,ref:"https://www.adobe.com/ru/products/photoshop.html"},{path:w,ref:"https://www.adobe.com/"},{path:_,ref:"https://www.adobe.com/"},{path:L,ref:"https://www.notion.so/"},{path:k,ref:"https://meet.google.com/landing"}]},{caption:"no-code",icons:[{path:C,ref:"https://zapier.com/"},{path:E,ref:"https://webflow.com/"},{path:S,ref:"https://www.framer.com/"},{path:P,ref:"https://wordpress.com/"}]},{caption:"artificial intelligence",icons:[{path:j,ref:"https://chatgpt.com/"},{path:I,ref:"https://copilot.microsoft.com/"},{path:x,ref:"https://www.midjourney.com/home"}]}],a={introduction:{greetings:"Hello 👋🏻 I’m",name:"Karthik SR",profession:"UX/UI Designer"},languages:{caption:"Languages",list:[{language:"English",level:100},{language:"Malayalam",level:100},{language:"Hindi",level:75}]},experience:{caption:"Experience",list:[{period:"Jun. 2023 - Present",position:"Marketing Manager",company:"Pankayam",jobNote:"Full-time",functions:["Strategy development and planning of campaigns that promote the business and generate genuine traffic","SEO Content Creation for Blogs, Website, Social media"]},{period:"2017 - Present",position:"Graphic / Web designer",company:"Freelance",jobNote:"",functions:["Development of internal projects from scratch, product design of brands","Landing page, webapps and hybrid apps","Coordinating with outside agencies, art services, web designer, marketing, printers, and colleagues as necessary."]},{period:"Sep. 2021 - Jun. 2023",position:"Legal Assistant",company:"Law Firm",jobNote:"Intern",functions:["Provide administrative support to lawyer and enhance office effectiveness","Handle communication with clients, witnesses etc.","Repare case briefs and summarize depositions, interrogatories and testimony"]}]},tools:{caption:"Tools",groups:V},education:{caption:"Education",list:[{period:{start:"2023",end:""},speciality:"UI/UX",skills:["UX","UI","research","DesignSysytem","Ui","wireframing","figma","Ux"],institution:"Coursera",like:!0},{period:{start:"2017",end:"2022"},speciality:"Law",skills:["law","legalStudies","contracts","internationalLaws"],institution:"University of Kerala",like:!1},{period:{start:"2017",end:""},speciality:"Graphic design",skills:["branding","web","illustration","adobe"],institution:"Coursrea",like:!1}]},interests:{caption:"Interests",list:["branding","design","photography","artifical intelligence","illustration","typography","social networks","research","dron pilot","games"]},links:{caption:"Let´s chat! I´m ready to work on excinting projects",eMail:"srkarthik.designscape@gmail.com"}},D="/test_CV/img/photo_sample.png",c="/test_CV/img/pencil.svg",T="/test_CV/img/heart.svg",q=({caption:e,list:t},n)=>`
        ...
        <img class="edit-icon" src="${n}" alt="Edit icon">
          ...
          ${t.map((s,i)=>`
            <li class="education__list__item">
              ${i===0?`<img class="like" src="${T}" alt="Like icon">`:""}
  ...
  `,B=({greetings:e,name:t,profession:n},s)=>`
...
`,F=({caption:e,list:t},n)=>{const s={25:"level-25",50:"level-50",75:"level-75",100:"level-100"};return`
